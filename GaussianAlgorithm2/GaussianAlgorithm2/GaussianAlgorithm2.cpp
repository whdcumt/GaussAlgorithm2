// GaussianAlgorithm2.cpp : 定义控制台应用程序的入口点。
//
...
//模糊算法2函数声明
void gaussBlur_2(IplImage *scl,IplImage *tcl,int w,int h,int r);
//均值模糊函数声明
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	gaussBlur_2(rImg, rImgBlur,rImgBlur->width ,rImgBlur->height,2);
	gaussBlur_2(gImg, gImgBlur,gImgBlur->width ,gImgBlur->height,2);
	gaussBlur_2(bImg, bImgBlur,bImgBlur->width ,bImgBlur->height,2);
